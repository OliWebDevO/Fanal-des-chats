                        ...
                        <div class="wpo-service-single-wrap">
                            ...
                            <div class="wpo-service-single-item">
                                <div class="wpo-service-single-title">
                                    <h3><?php the_field('legue_intro_titre'); ?></h3>
                                </div>
                            ...
                            <div class="wpo-service-single-item list-widget">
                                <div class="wpo-service-single-title">
                                    <h3><?php the_field('legue_types_titre'); ?></h3>
                                </div>
                            ...
                            <div class="wpo-service-single-item">
                                <div class="wpo-service-single-title">
                                    <h3><?php the_field('legue_demarches_titre'); ?></h3>
                                </div>
                            ...
                            <div class="wpo-service-single-item list-widget">
                                <div class="wpo-service-single-title">
                                    <h3><?php the_field('legue_avantages_titre'); ?></h3>
                                </div>
                                <ul>
                                    <?php foreach ($lignes as $ligne) : ?>
                                    <li><?php echo esc_html($ligne); ?></li>
                            ...
                            <div class="wpo-service-single-item">
                                <div class="wpo-service-single-title">
                                    <h3><?php the_field('legue_quiz_titre'); ?></h3>
                                </div>
