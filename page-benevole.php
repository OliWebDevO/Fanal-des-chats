<?php get_template_part("partials/header"); ?>
        ...
        $mission_query = new WP_Query(array(
            ...
            'posts_per_page' => 1,
            'meta_query' => array(array('key' => 'benevole_type', 'value' => 'mission')),
        ));
        ...
        <section class="about-section section-padding orange benevole-block">
            <div class="wraper">
                ...
                <div class="right">
                    ...
                    <h2><?php the_field('benevole_mission_titre'); ?></h2>
        ...
        $besoins_query = new WP_Query(array(
            'post_type' => 'page_benevole',
            'posts_per_page' => 1,
            'meta_query' => array(array('key' => 'benevole_type', 'value' => 'besoins')),
        ));
        ...
        <section class="about-section section-padding benevole-block">
            <div class="wraper">
                <div class="right">
                    ...
                    <h2><?php the_field('benevole_besoins_titre'); ?></h2>
        ...
        $approche_query = new WP_Query(array(
            'post_type' => 'page_benevole',
            'posts_per_page' => 1,
            'meta_query' => array(array('key' => 'benevole_type', 'value' => 'approche')),
        ));
        ...
        <section class="about-section section-padding orange benevole-block">
            <div class="wraper">
                ...
                <div class="right">
                    ...
                    <h2><?php the_field('benevole_approche_titre'); ?></h2>
        ...
        $quotidien_query = new WP_Query(array(
            'post_type' => 'page_benevole',
            'posts_per_page' => 1,
            'meta_query' => array(array('key' => 'benevole_type', 'value' => 'quotidien')),
        ));
        ...
        <section class="about-section section-padding benevole-block">
            <div class="wraper">
                <div class="right">
                    ...
                    <h2><?php the_field('benevole_quotidien_titre'); ?></h2>
                    <ul class="benevole-list">
                        <?php foreach ($lignes as $ligne) : ?>
                        <li><?php echo esc_html($ligne); ?></li>
                        <?php endforeach; ?>
        ...
        $quiz_query = new WP_Query(array(
            'post_type' => 'page_benevole',
            'posts_per_page' => 1,
            'meta_query' => array(array('key' => 'benevole_type', 'value' => 'quiz')),
        ));
        ...
        <section class="about-section section-padding orange benevole-block">
            <div class="wraper">
                ...
                <div class="right">
                    ...
                    <h2><?php the_field('benevole_quiz_titre'); ?></h2>
        ...
        $formulaire_query = new WP_Query(array(
            'post_type' => 'page_benevole',
            'posts_per_page' => 1,
            'meta_query' => array(array('key' => 'benevole_type', 'value' => 'formulaire')),
        ));
        ...
        $faq_query = new WP_Query(array(
            'post_type' => 'page_benevole',
            'posts_per_page' => 1,
            'meta_query' => array(array('key' => 'benevole_type', 'value' => 'faq')),
        ));
                                ...
                                <div class="col-lg-12 col-12">
                                    <div class="wpo-benefits-item">
                                        <div class="accordion" id="accordionExample">
                                            <?php
                                            $faq_items_data = get_field('benevole_faq_items');
                                            if ($faq_items_data) :
        ...
        $cta_query = new WP_Query(array(
            'post_type' => 'page_benevole',
            'posts_per_page' => 1,
            'meta_query' => array(array('key' => 'benevole_type', 'value' => 'cta')),
        ));
