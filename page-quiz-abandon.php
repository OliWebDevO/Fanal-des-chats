 ...
 * Description: Quiz sur l'abandon des chats
 */
...
$intro_desc = get_field($prefix . '_quiz_intro_description', $quiz_post) ?: 'Découvrez s\'il existe des alternatives à l\'abandon de votre chat.';
