<?php get_template_part("partials/header"); ?>
        ...
        $intro_query = new WP_Query(array(
            'post_type' => 'page_don',
            'posts_per_page' => 1,
            'meta_query' => array(array('key' => 'don_type', 'value' => 'intro')),
        ));
        ...
        <section class="about-section section-padding orange benevole-block">
            <div class="wraper">
                ...
                <div class="right">
                    ...
                    <h2><?php the_field('don_intro_titre'); ?></h2>
        ...
        $avantages_query = new WP_Query(array(
            'post_type' => 'page_don',
            'posts_per_page' => 1,
            'meta_query' => array(array('key' => 'don_type', 'value' => 'avantages')),
        ));
        ...
        <section class="about-section section-padding benevole-block">
            <div class="wraper">
                <div class="right">
                    ...
                    <h2><?php the_field('don_avantages_titre'); ?></h2>
        ...
        $quiz_query = new WP_Query(array(
            'post_type' => 'page_don',
            'posts_per_page' => 1,
            'meta_query' => array(array('key' => 'don_type', 'value' => 'quiz')),
        ));
        ...
        <section class="about-section section-padding orange benevole-block">
            <div class="wraper">
                ...
                <div class="right">
                    ...
                    <h2><?php the_field('don_quiz_titre'); ?></h2>
        ...
        $faq_query = new WP_Query(array(
            'post_type' => 'page_don',
            'posts_per_page' => 1,
            'meta_query' => array(array('key' => 'don_type', 'value' => 'faq')),
        ));
                                ...
                                <div class="col-lg-12 col-12">
                                    <div class="wpo-benefits-item">
                                        <div class="accordion" id="accordionExample">
                                            <?php
                                            $faq_items_data = get_field('don_faq_items');
                                            if ($faq_items_data) :
        ...
        $cta_query = new WP_Query(array(
            'post_type' => 'page_don',
            'posts_per_page' => 1,
            'meta_query' => array(array('key' => 'don_type', 'value' => 'cta')),
        ));
