<?php get_template_part("partials/header"); ?>
        ...
        $mission_query = new WP_Query(array(
            ...
            'posts_per_page' => 1,
            'meta_query' => array(array('key' => 'emploi_type', 'value' => 'mission')),
        ));
        ...
        <section class="about-section section-padding orange benevole-block">
            <div class="wraper">
                <div class="left">
                    <div class="image">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/images/illustrations/18_brown cat.png" alt="">
                        <div class="shape">
                ...
                <div class="right">
                    ...
                    <h2><?php the_field('emploi_mission_titre'); ?></h2>
                    <?php if (get_field('emploi_mission_paragraphe_1')) : ?>
                        <p><?php the_field('emploi_mission_paragraphe_1'); ?></p>
                    <?php endif; ?>
                    <?php if (get_field('emploi_mission_paragraphe_2')) : ?>
                        <p><?php the_field('emploi_mission_paragraphe_2'); ?></p>
                    <?php endif; ?>
                    <div class="about-btn">
                        <a href="#cta" class="theme-btn-s2">Postuler</a>
                    </div>
                </div>
            </div>
        </section>
        ...
        $besoins_query = new WP_Query(array(
            'post_type' => 'page_emploi',
            'posts_per_page' => 1,
            'meta_query' => array(array('key' => 'emploi_type', 'value' => 'besoins')),
        ));
        if ($besoins_query->have_posts()) : while ($besoins_query->have_posts()) : $besoins_query->the_post();
            $liste = get_field('emploi_besoins_liste');
            $lignes = preg_split('/\r\n|\r|\n/', $liste);
        ...
        <section class="about-section section-padding benevole-block">
            <div class="wraper">
                <div class="right">
                    ...
                    <h2><?php the_field('emploi_besoins_titre'); ?></h2>
                    <?php if (get_field('emploi_besoins_texte')) : ?>
                        <p><?php the_field('emploi_besoins_texte'); ?></p>
                    <?php endif; ?>
        ...
        $approche_query = new WP_Query(array(
            'post_type' => 'page_emploi',
            'posts_per_page' => 1,
            'meta_query' => array(array('key' => 'emploi_type', 'value' => 'approche')),
        ));
        ...
        <section class="about-section section-padding orange benevole-block">
            <div class="wraper">
                ...
                <div class="right">
                    ...
                    <h2><?php the_field('emploi_approche_titre'); ?></h2>
                    <p><?php the_field('emploi_approche_texte'); ?></p>
                </div>
            </div>
        </section>
        <?php endwhile; endif; wp_reset_postdata(); ?>
        ...
        $quotidien_query = new WP_Query(array(
            'post_type' => 'page_emploi',
            'posts_per_page' => 1,
            'meta_query' => array(array('key' => 'emploi_type', 'value' => 'quotidien')),
        ));
        if ($quotidien_query->have_posts()) : while ($quotidien_query->have_posts()) : $quotidien_query->the_post();
            $liste = get_field('emploi_quotidien_liste');
            $lignes = preg_split('/\r\n|\r|\n/', $liste);
            $lignes = array_filter(array_map('trim', $lignes), function($l) { return $l !== ''; });
        ?>
        <section class="about-section section-padding benevole-block">
            <div class="wraper">
                <div class="right">
                    ...
                    <h2><?php the_field('emploi_quotidien_titre'); ?></h2>
                    <ul class="benevole-list">
                        <?php foreach ($lignes as $ligne) : ?>
                        <li><?php echo esc_html($ligne); ?></li>
                        <?php endforeach; ?>
        ...
        $quiz_query = new WP_Query(array(
            'post_type' => 'page_emploi',
            'posts_per_page' => 1,
            'meta_query' => array(array('key' => 'emploi_type', 'value' => 'quiz')),
        ));
        ...
        <section class="about-section section-padding orange benevole-block">
            <div class="wraper">
                ...
                <div class="right">
                    ...
                    <h2><?php the_field('emploi_quiz_titre'); ?></h2>
                    <p><?php the_field('emploi_quiz_texte'); ?></p>
                    <div class="about-btn">
                        <a href="<?php echo home_url('/quiz-emploi'); ?>" class="theme-btn-s2">Participez au Quiz</a>
                    </div>
                </div>
            </div>
        </section>
        ...
        $formulaire_query = new WP_Query(array(
            'post_type' => 'page_emploi',
            'posts_per_page' => 1,
            'meta_query' => array(array('key' => 'emploi_type', 'value' => 'formulaire')),
        ));
        ...
        <section class="about-section section-padding benevole-block">
            <div class="wraper">
                <div class="right">
                    ...
                    <h2><?php the_field('emploi_formulaire_titre'); ?></h2>
                    <p><?php the_field('emploi_formulaire_texte'); ?></p>
                    <div class="about-btn">
        ...
        $faq_query = new WP_Query(array(
            'post_type' => 'page_emploi',
            'posts_per_page' => 1,
            'meta_query' => array(array('key' => 'emploi_type', 'value' => 'faq')),
        ));
                ...
                <div class="row align-items-center">
                    <div class="col-lg-12">
                        <div class="section-title">
                            <h2><?php the_field('emploi_faq_titre'); ?></h2>
                        </div>
                    </div>
                    <div class="col-lg-12">
                                    ...
                                    <div class="wpo-benefits-item">
                                        <div class="accordion" id="accordionExample">
                                            ...
                                            foreach ($faq_items as $item) :
                                                $question = get_field('emploi_faq_question_' . $item['index']);
                                                $reponse = get_field('emploi_faq_reponse_' . $item['index']);
                                                if ($question && $reponse) :
                                            ?>
        ...
        $cta_query = new WP_Query(array(
            'post_type' => 'page_emploi',
            'posts_per_page' => 1,
            'meta_query' => array(array('key' => 'emploi_type', 'value' => 'cta')),
        ));
                            ...
                            <div class="wpo-service-single-item">
                                <div class="wpo-service-contact-area">
                                    <div class="wpo-contact-title">
                                        <h2><?php the_field('emploi_cta_titre'); ?></h2>
