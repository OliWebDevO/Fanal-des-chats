                        ...
                        <div class="wpo-service-single-wrap">
                            ...
                            <div class="wpo-service-single-item">
                                <div class="wpo-service-single-title">
                                    <h3><?php the_field('emploi_mission_titre'); ?></h3>
                                </div>
                            ...
                            <div class="wpo-service-single-item">
                                <div class="wpo-service-single-title">
                                    <h3><?php the_field('emploi_besoins_titre'); ?></h3>
                                </div>
                            ...
                            <div class="wpo-service-single-item">
                                <div class="wpo-service-single-title">
                                    <h3><?php the_field('emploi_approche_titre'); ?></h3>
                                </div>
                            ...
                            <div class="wpo-service-single-item list-widget">
                                <div class="wpo-service-single-title">
                                    <h3><?php the_field('emploi_quotidien_titre'); ?></h3>
                                </div>
                                <ul>
                                    <?php foreach ($lignes as $ligne) : ?>
                                    <li><?php echo esc_html($ligne); ?></li>
                            ...
                            <div class="wpo-service-single-item">
                                <div class="wpo-service-single-title">
                                    <h3><?php the_field('emploi_quiz_titre'); ?></h3>
                                </div>
                            ...
                            <div class="wpo-service-single-item">
                                <div class="wpo-service-single-title">
                                    <h3><?php the_field('emploi_formulaire_titre'); ?></h3>
                                </div>
