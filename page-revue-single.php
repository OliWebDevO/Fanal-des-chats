       ...
       <!-- start wpo-page-title -->
        ...
        <section class="wpo-shop-single-section section-padding orange">
            <div class="container">
                <div class="row">
                    <div class="col col-lg-6 col-12">
                        <div class="shop-single-slider">
                            <div class="slider-for">
                                <div><img src="<?php bloginfo("template_url")?>/assets/images/shop/shop-single/1.jpg" alt=""></div>
                                <div><img src="<?php bloginfo("template_url")?>/assets/images/shop/shop-single/2.jpg" alt=""></div>
                                <div><img src="<?php bloginfo("template_url")?>/assets/images/shop/shop-single/5.jpg" alt=""></div>
                                <div><img src="<?php bloginfo("template_url")?>/assets/images/shop/shop-single/4.jpg" alt=""></div>
                                <div><img src="<?php bloginfo("template_url")?>/assets/images/shop/shop-single/6.jpg" alt=""></div>
                                <div><img src="<?php bloginfo("template_url")?>/assets/images/shop/shop-single/2.jpg" alt=""></div>
                                <div><img src="<?php bloginfo("template_url")?>/assets/images/shop/shop-single/3.jpg" alt=""></div>
                            </div>
                            <div class="slider-nav">
                                <div><img src="<?php bloginfo("template_url")?>/assets/images/shop/shop-single/thumb/img-1.jpg" alt=""></div>
                                <div><img src="<?php bloginfo("template_url")?>/assets/images/shop/shop-single/thumb/img-2.jpg" alt=""></div>
                                <div><img src="<?php bloginfo("template_url")?>/assets/images/shop/shop-single/thumb/img-5.jpg" alt=""></div>
                                <div><img src="<?php bloginfo("template_url")?>/assets/images/shop/shop-single/thumb/img-4.jpg" alt=""></div>
                                <div><img src="<?php bloginfo("template_url")?>/assets/images/shop/shop-single/thumb/img-6.jpg" alt=""></div>
                                <div><img src="<?php bloginfo("template_url")?>/assets/images/shop/shop-single/thumb/img-2.jpg" alt=""></div>
                                <div><img src="<?php bloginfo("template_url")?>/assets/images/shop/shop-single/thumb/img-3.jpg" alt=""></div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="col col-lg-10 col-12">
                                            <div class="client-rv">
                                                <div class="client-pic">
                                                    <img src="<?php bloginfo("template_url")?>/assets/images/shop/shop-single/review/img-1.jpg" alt="">
                                                </div>
                                                <div class="details">
                                            ...
                                            <div class="client-rv">
                                                <div class="client-pic">
                                                    <img src="<?php bloginfo("template_url")?>/assets/images/shop/shop-single/review/img-2.jpg" alt="">
                                                </div>
                                                <div class="details">
                                                    <div class="name-rating-time">
                                                        <div class="name-rating">
