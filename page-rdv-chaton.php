...
<?php get_template_part("partials/header"); ?>
                ...
                <div class="row">
                    <div class="col col-xs-12">
                        <div class="wpo-breadcumb-wrap">
                            <h2>Rendez-vous — Adoption Chaton</h2>
                            <ol class="wpo-breadcumb-wrap">
                                <li><a href="<?php echo home_url('/'); ?>">Accueil</a></li>
                                <li>Rendez-vous Chaton</li>
                            </ol>
                        </div>
                    </div>
                </div>
        ...
        <section class="about-section section-padding orange benevole-block">
            <div class="wraper">
                <div class="right">
                    ...
                    <h2>Adoption Chaton</h2>
                    <p>Prenez rendez-vous pour rencontrer un chaton. Ce créneau de <strong>45 minutes</strong> est un peu plus long car les chatons demandent davantage de conseils sur l'éducation, l'alimentation et l'adaptation à leur nouveau foyer.</p>
                </div>
                <div class="left">
                    <div class="image">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/images/illustrations/14_orange cat.png" alt="Chaton du refuge">
                        <div class="shape">
        ...
        <!-- Bloc rendez-vous Adoption Chaton -->
                                    ...
                                    <div class="wpo-benefits-item">
                                        <div class="accordion-item" style="border-radius: 8px;">
                                            <h3 class="accordion-header">
                                                <button class="accordion-button" type="button" style="pointer-events: none; cursor: default;">
                                                    Adoption Chaton
                                                    <style>.wpo-benefits-item .accordion-button::after { display: none; }</style>
                                                </button>
                                            </h3>
