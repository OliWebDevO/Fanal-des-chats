...
<?php get_template_part("partials/header"); ?>
                ...
                <div class="row">
                    <div class="col col-xs-12">
                        <div class="wpo-breadcumb-wrap">
                            <h2>Rendez-vous — Adoption Chat</h2>
                            <ol class="wpo-breadcumb-wrap">
                                <li><a href="<?php echo home_url('/'); ?>">Accueil</a></li>
                                <li>Rendez-vous Chat</li>
                            </ol>
                        </div>
                    </div>
                </div>
        ...
        <section class="about-section section-padding orange benevole-block">
            <div class="wraper">
                <div class="right">
                    ...
                    <h2>Adoption Chat</h2>
                    <p>Prenez rendez-vous pour rencontrer un chat adulte. Ce créneau de <strong>30 minutes</strong> vous permet de faire connaissance avec le chat, d'échanger avec notre équipe sur son caractère et ses besoins.</p>
                </div>
                <div class="left">
                    <div class="image">
        ...
        <!-- Bloc rendez-vous Adoption Chat -->
                                            ...
                                            <div class="accordion-collapse collapse show">
                                                <div class="accordion-body">
                                                    ...
                                                    <div class="rdv-calendar">
                                                        ...
                                                        <div class="calendly-inline-widget" data-url="https://calendly.com/lefanaldeschats/30min?locale=fr" style="min-width:320px;height:700px;"></div>
                                                    </div>
                                                    <?php else : ?>
