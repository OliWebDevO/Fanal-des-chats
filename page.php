<?php get_template_part("partials/header"); ?>
        ...
        <section class="about-section section-padding">
            <div class="wraper">
                <div class="left">
                    <div class="image">
                        <img src="<?php bloginfo("template_url")?>/assets/images/about.png" alt="">
                        <div class="shape">
        ...
        <section class="funfact-section">
            <div class="section-top-image">
                <img src="<?php bloginfo("template_url")?>/assets/images/funfact/top-image.jpg" alt="">
            </div>
            <div class="container">
                <div class="row">
                ...
                <div class="pricing-wrap row g-0 align-items-center">
                    <div class="col col-lg-4 col-md-6 col-12">
                        <div class="pricing-card">
                            <h2>Friendly Pack</h2>
                            <div class="price"> <span class="simbol">$</span>100 <span>/ Visit</span></div>
                            <ul class="features">
                                <li>15 Days Services</li>
                                <li>Pet Showar</li>
                                <li>Intensive Checkup</li>
                                <li>Grooming</li>
                                <li>Hair & Nail Cut</li>
                            </ul>
                    ...
                    <div class="col col-lg-4 col-md-6 col-12">
                        <div class="pricing-card">
                            ...
                            <div class="price"> <span class="simbol">$</span>185 <span>/ Visit</span></div>
                            <ul class="features">
                                <li>15 Days Services</li>
                                <li>Pet Showar</li>
                                <li>Intensive Checkup</li>
