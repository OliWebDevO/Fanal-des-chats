...
<body>
    ...
    <div class="page-wrapper">
                            ...
                            <div class="container-fluid">
                                <div class="slide-content">
                                    <div data-swiper-parallax="300" class="slide-sub-title">
                                        <h2>To Ensure <span>Perfect</span> <span class="text">Service</span>
                                            Of Your dog</h2>
                                    </div>
                                    ...
                                    <div data-swiper-parallax="500" class="slide-btns">
                                        <a href="<?php echo home_url('/about'); ?>" class="theme-btn-s2">About Us</a>
                                    </div>
                                </div>
                            </div>
                            <div class="bg-shape">
                                <img src="assets/images/slider/shape-bg.svg" alt="">
                            </div>
                            <div class="shape-1">
                    ...
                    <div class="swiper-slide">
                        <div class="slide-inner slide-bg-image" data-background="assets/images/slider/slide-2.jpg">
                            <div class="container-fluid">
                                <div class="slide-content">
                                    <div data-swiper-parallax="300" class="slide-sub-title">
                                        <h2>The Best <br> <span>Care</span> <span class="text">for Best</span>
                                            Friend</h2>
                                    </div>
        ...
        <section class="about-section-s3 section-padding">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-12">
                        <div class="about-image">
                            <div class="image1">
                                <img src="assets/images/about/about-8.jpg" alt="">
                            </div>
                            <div class="image2">
                                <img src="assets/images/about/about-9.jpg" alt="">
                                <div class="shape">
                                    <img src="assets/images/about/shape13.png" alt="">
                                </div>
                            </div>
                            <div class="image3">
                                <img src="assets/images/about/about-10.jpg" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-12">
                        <div class="right-content">
                            ...
                            <div class="author-wrap">
                                <ul class="author-img">
                                    <li><img src="assets/images/about/aut-1.jpg" alt=""></li>
                                    <li class="active"><img src="assets/images/about/aut-2.jpg" alt=""></li>
                                    <li><img src="assets/images/about/aut-3.jpg" alt=""></li>
                                </ul>
                                <div class="author-text">5m+ Customer <div class="shape"><img
                                            src="assets/images/about/shape10.svg" alt=""></div>
                                </div>
                                <div class="contact">
                                    <div class="icon">
            ...
            <div class="dog-sidimg">
                <img src="assets/images/about/dog-sid-img.png" alt="">
            </div>
        </section>
        <!-- end about -->

        <!-- start get-quate -->
        <section class="get-quate-section-s2 section-padding">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-12">
                        <div class="content">
                            ...
                            <div class="item-wrap">
                                ...
                                <ul>
                                    <li><i class="ti-check"></i>service electrical layout, design</li>
                                    <li><i class="ti-check"></i>Compliance and Enforcement</li>
                                    <li><i class="ti-check"></i>Becoming a registered provider</li>
                                </ul>
                            </div>
                            <ul class="buttom-item">
                                <li>
                                    <div class="text">
            ...
            <div class="shape">
                <img src="assets/images/gq-shap.svg" alt="">
            </div>
            <div class="shape2">
                <img src="assets/images/gq-shap-2.svg" alt="">
            </div>
        </section>
        <!-- end get-quate -->
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="testimonial-slider owl-carousel">
                            <div class="item">
                                ...
                                <h3>Kind friendly and professional, and best of all Anna absolutely loved them. I would
                                    recommend Apet to anyone looking for perfect Pet care agency.</h3>
                ...
                <div class="container-fluid">
                    <div class="row g-0">
                        <div class="col col-lg-6 col-12">
                            <p class="copyright"> Copyright &copy; 2025 Petlox. All
                                Rights Reserved.</p>
                        </div>
                        <div class="col col-lg-6 col-12">
                            <ul class="right">
